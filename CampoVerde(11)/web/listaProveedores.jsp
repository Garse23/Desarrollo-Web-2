...
<html lang="en">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form> 
                                                    <input type="hidden" name="idProducto" value="<%=p.getId() %>">
                                                    <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#ModalEditar<%= p.getId()%>">Editar</button>
                                                </form>
                                            </td>
                                        </tr>
    ...
    <% for (Proveedor p : proveedores) { %>
    <div class="modal fade" id="ModalEditar<%= p.getId()%>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="EditarCliente" method="post">
                        <input type="hidden" name="idProducto" id="idProducto" value="<%= p.getId()%>">
                        <div class="form-group">
                            <label for="nombre">Nombre:</label>
                            <input type="text" id="nombre" name="nombre" class="form-control" value="<%= p.getId()%>" required><br>
                        </div>
                        <div class="form-group">
                            <label for="precio">Precio:</label>
                            <input type="text" id="precio" name="precio" class="form-control" value="<%= p.getId()%>" required><br>
                        </div>
                        <div class="form-group">
                            <label for="stock">Stock:</label>
                            <input type="text" id="stock" name="stock" class="form-control" value="<%= p.getId()%>" required><br>
                        </div>
                        <div class="form-group">
